  ...
  return (
    <div className="hero-container">
      <div className="hero-text-container">
        <div className="hero-quote">"For the love of open source"</div>
        ...
        <div className="hero-button-container">
          <div className="manual">
            <a href={STUDENT_MANUAL_LINK} target="_blank">
              <button className="hero-button left-button">
                Student Manual
              </button>{" "}
            </a>
            <a href={MENTOR_MANUAL_LINK} target="_blank">
              <button className="hero-button right-button">
                Mentor Manual
              </button>{" "}
            </a>
          </div>
