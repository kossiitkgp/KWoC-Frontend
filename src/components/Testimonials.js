...
export default function Testimonial() {
  return (
    <div className='FAQs'>
      ...
      <div className='container'>
        <p>
          KWoC '17 was my first mentoring experience and I enjoyed working with
          talented people who had the zeal and vigour to learn new things. Some
          of my mentees were also accepted as GSoC '18 students, which makes me
          proud and happy in the true sense of the word. It's a great initiative
          by KOSS to promote the open source culture among students and I hope
        ...
        <p>
          ...
          maintained that the quality of the coding program never touched a low
          point and maintained the coding frequency consistent throughout the
          program.{' '}
        </p>
        ...
        <p>
          My project was a normal one before KWOC, something I had worked on in
          a hackathon. But I loved the idea but found it hard to do alone. But
          due to KWoC I got very good quality amazing contributors who helped to
          changed that small project into a top 3 product in Product Hunt and
        ...
        <p>
          ...
          students learning open-source development from KWoC by contributing to
          the projects. Some of my mentees have even gone ahead to do a GSoC
          project as well in the following summers, and are definitely are still
        ...
        <p>
          ...
          recommend open source enthusiasts and GSoC aspirants to participate in
          KWoC.{' '}
        </p>
        ...
        <p>
          ...
          the level of contribution is quite apt, considering for the beginners.
        </p>
        ...
        <p>
          ...
          Kharagpur for organizing such an event. I sincerely hope to be a part
          of more and more such programs.
        </p>
        ...
        <p>
          ...
          technical skills. Thank you IIT Kharagpur, KOSS for hosting a beginner
          friendly program.
        </p>
        ...
        <p>
          ...
          anything about how that much code works together. But after this event
          all that was gone.
        </p>
        ...
        <p>
          KWoC was a lot more than experience and learning. Now, I had worked on
          the repositories and had interacted with their makers.
        </p>
        ...
        <p>
          I got to learn a lot about web scraping and webdriver automation.Lots
          of thanks to my mentor Nitin Choudhary and KOSS for such a wonderful
          initiative.
        </p>
        ...
        <p>
          The project consisted of functions to decode and encode functions and
          some other features. I thought of developing a GUI to decode and
          encode in morsecode.
        </p>
        ...
        <p>
          ...
          Kharagpur Winter of code for the students who are eager to contribute
        ...
        <p>
          ...
          project to the open source community. Among KWOC projects Sheldonisms
          impressed me.
        </p>
