  ...
  render() {
    ...
    return (
      <div className="navbar">
        <nav className={`navbar is-fixed-top  ${this.state.scrollClass}`} role="navigation" aria-label="main navigation">
          <div className="container">
            <div className="navbar-brand">
              ...
              <button className={`navbar-burger burger ${clickClass}`} aria-label="menu" aria-expanded="false" data-target="navbarBasicExample" onClick={this.handleClick}>
