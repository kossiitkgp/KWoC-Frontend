...
export default function WhyKwoc(){
    return(
      <>
        ...
        <p className="text-zinc-400 text-center mb-4 text-lg font-normal lg:text-2xl sm:px-16 xl:px-96 xl:pb-32 mt-10">Kharagpur Winter of Code is a 5-week long online program for students who are new to open source software development. The program not only helps students to get involved in open source, but also prepares them for many open source summer programs; Google Summer of Code being one of them.</p>
