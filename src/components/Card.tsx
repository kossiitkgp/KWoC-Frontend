...
export default function Card(props: any) {
  return (
    <div className="hover-card text-zinc-100 text-center bg-black/50 backdrop-blur-sm mx-auto mb-10 lg:w-1/4 sm:w-3/4 px-4 py-16 border border-[#FFFFFF]/[0.16] rounded-[10px] hover:cursor-pointer">
