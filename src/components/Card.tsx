...
export default function Card(props: any) {
    ...
    return (
        <div className="text-zinc-100 text-center bg-black/50 backdrop-blur-lg mx-auto mb-10 lg:w-1/4 sm:w-3/4 p-8 border border-[#FFFFFF]/[0.16] rounded-[10px] hover:cursor-pointer"
