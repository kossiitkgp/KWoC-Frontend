...
function Navbar() {
  ...
  return (
    <div className='fixed inset-x-0 top-4 z-50 w-full'>
      <div className='flex shadow-md items-center justify-between max-w-7xl gap-4 mx-auto border border-[#FFFFFF]/[0.16] px-4 py-2 rounded-lg w-[95%] inset-x-0 backdrop-blur-md z-50 xs:max-md:text-sm'>
