...
export const FAQs: FAQItem[] = [
  {
    ...
    answer: [
      ...
      "To learn more about git and github, check <a style='font-weight:600; color:#007bff;' target='_blank' href='https://github.com/kossiitkgp/events/tree/main/2023/Spring/Git-github'>these</a>.",
    ],
  },
  {
    question:
