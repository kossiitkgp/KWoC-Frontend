...
export const FAQs = [
  ...
  {
    "question": "What is the deadline for selecting projects? How many projects can we select?",
    "answer": [
  ...
  {
    "question": "Where does KWoC occur? Do I need to be a student of IIT Kharagpur?",
    "answer": [
  ...
  {
    "question": "What is the purpose of this program? Is this some kind of internship?",
    "answer": [
  ...
  {
    "question": "Can I show the contributions that I have made in KWoC for participating in any competitions?",
    "answer": [
  ...
  {
    "question": "Is there any other similar kind of program that I might find interesting?",
    "answer": [
  ...
  {
    "question": "What are the minimum contributions I have to do to get successfully recognized as to have completed the programme?",
    "answer": [
