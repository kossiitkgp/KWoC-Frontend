          ...
          <div className="columns is-multiline is-centered">
            <div className="column has-text-centered is-4">
              ...
              <p>
                ...
                things. Some of my mentees were also accepted as GSoC '18
                students, which makes me proud and happy in the true sense of
                the word. It's a great initiative by KOSS to promote the open
                source culture among students and I hope the next version
                achieves greater heights and influences more lives.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                ...
                because of inputs from participants. Regular chaperoning from
                KOSS maintained that the quality of the coding program never
                touched a low point and maintained the coding frequency
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                My project was a normal one before KWOC, something I had worked
                on in a hackathon. But I loved the idea but found it hard to do
                alone. But due to KWoC I got very good quality amazing
                contributors who helped to changed that small project into a top
                3 product in Product Hunt and featured in many tech
                publications.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                ...
                students learning open-source development from KWoC by
                contributing to the projects. Some of my mentees have even gone
                ahead to do a GSoC project as well in the following summers, and
                are definitely are still actively contributing to open-source.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                KWoC has provided me opportunities to learn more about open
                source, accelerate the growth of my projects, along with helping
                new developers explore the power and opportunities of FOSS. I
                highly recommend open source enthusiasts and GSoC aspirants to
                participate in KWoC.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                My experience with Kharagpur Winter of Code has been quite good,
                as the level of contribution is quite apt, considering for the
                beginners.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                I used to think how could I contribute because I couldn't
                understand anything about how that much code works together. But
                after this event all that was gone.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                ...
                environment of everyone coming together to learn &amp; teach is
                a unique one.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                ...
                programming environment with experienced mentors and make them
                ready for GSoC.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                KWoC was a lot more than experience and learning. Now, I had
                worked on the repositories and had interacted with their makers.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                ...
                automation.Lots of thanks to my mentor Nitin Choudhary and KOSS
                for such a wonderful initiative.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                The project consisted of functions to decode and encode
                functions and some other features. I thought of developing a GUI
                to decode and encode in morsecode.
              </p>
              ...
              <p>
                <a href="http://localhost:8000/static/files/arindam.pdf">
                  Blog
                </a>
              </p>
            </div>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                Thanks to the people at Kharagpur open source society for
                organising Kharagpur Winter of code for the students who are
                eager to contribute to open source community.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                That amazing feeling when you make your first commit or
                successfully merge your first pull request is something which
                cannot be described in words.Thank you KWOC for providing such a
                great opportunity.
              </p>
            ...
            <div className="column has-text-centered is-4">
              ...
              <p>
                I came to know about KWOC and was happy to contribute yet
                another project to the open source community. Among KWOC
                projects Sheldonisms impressed me.
              </p>
